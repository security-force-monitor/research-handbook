...
Every piece of data collected by the Monitor is individually sourced and each data point about Persons and Organizations are assigned a confidence rating. The Research Handbook :ref:`section on sources and confidence` provides more guidance about this aspect of the data.

Detailed guidance about the fields used by the Monitor to record data about :ref:`Organizations </en/datamodel/organizations.md>`__, `Persons` and Incidents is provided in the remainder of this document.
