...
We structure all dates into ranges with a first and last date. This means even a single day, such as 5 May 2025 would be entered with a first date of 2025-05-05 and a last date of 2025-05-05. Ranges can be precise, meaning details of the claim were true for all dates in the range. Or ranges can be imprecise, meaning details of the claim were true for at least one date in the range. All dates should be entered in the YYYY-MM-DD format.
