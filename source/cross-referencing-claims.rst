...
Similarly, sometimes multiple citations are needed to surface the claims made by a single citation. That process is explored further in the next section :ref:`Claims With Multiple Citations`.
