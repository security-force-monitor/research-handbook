...
Every :ref:`positioning` should be "taken on" to parent units or the :ref:`relation:related_unit:refs:assertion` units, which have a :ref:`relation` that overlaps any :ref:`positioning` claim for any subordinate :ref:`unit`.
...
See the section :ref:`Superior Units Taking On Positionings and Classifications of Subordinates` for more guidance.
